...
const SEARCHES = [
  ...
  'annem uyurken onu nasi oldururum',
  'nasi kucuk yasta bi kizi tawlayabilirim',
  'satilik cocuk porno',
  'insanlarla nasi konusabilirim',
  'bestgore.com',
  'BI KADINI NASIL KESEBILIRIM',
  'Nasi semih celik gibi olabilirim',
  'ikbal uzuner yapicam tum kizlari',
  'torbaci nasi bulabilirim'
]
...
const PHRASES = [
  'OIOIOIOIOIOIOIOIOIOIOIOIOIOIOIOIOIOIOIOIOIOIOIOI',
  'skibi toilet sigma rizz gyat fanumtax',
  'childpornchildpornchildpornchildpornchildporn',
  'the cocaine is not goooooodd for yooooouuuuuuuuuu',
  'god god god god god god god god god god',
  'abcdefghijklmnopqrstuvwxyz abcdefghijklmnopqrstuvwxyz',
  'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaak',
  'PLEASE SAVE ME PLEASE SAVE ME PLEASE SAVE ME PLEASE SAVE ME PLEASE SAVE ME PLEASE SAVE ME '
]
